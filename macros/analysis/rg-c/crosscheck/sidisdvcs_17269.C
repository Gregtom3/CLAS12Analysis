/*
  ...
  Purpose: To analyze Run 17269 and extract the Faraday Cup accumulation for h=+1, h=-1 beam helicities and the x-Q2 for each event. This is all the necessary information required to produce the target polarization of the run later
...
int sidisdvcs_17269(){
  // Constants
  const char * hipofile = "/volatile/clas12/rg-c/production/ana_data/HBT/8.3.2/dst/train/sidisdvcs/sidisdvcs_017269.hipo";
  ...
  TFile *fOut = new TFile("data17269.root","RECREATE");
