...
int pipi0_MC_study(
		  const char * hipoFile = "/cache/clas12/rg-a/production/montecarlo/clasdis/fall2018/torus-1/v1/bkg45nA_10604MeV/45nA_job_3301_*.hipo",
		  ...
		  )
{
  ...
  settings._ignoreOtherRecoParticles = false; // Save to tree particle info of uninterested PIDs
